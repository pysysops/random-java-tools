...
public class LDAPTest extends Formatter {
  private static final Logger theLogger = Logger.getLogger(LDAPTest.class.getName());

  public static void main(final String[] args) throws IOException {

    final Properties props = new Properties();
    props.load(LDAPTest.class.getResourceAsStream("LDAPTest.properties"));

    try {
      theLogger.setUseParentHandlers(false);
      final ConsoleHandler handler = new ConsoleHandler();
      handler.setFormatter(new LDAPTest());
